  ...
  <a-layout-header class="header">
    <div class="header-content">
      ...
      <a-menu v-model:selectedKeys="selectedKeys" mode="horizontal" class="nav-menu">
        ...
        <a-menu-item key="appointment" @click="navigateTo('/appointment/create')">
          <CalendarOutlined />
          预约挂号
        </a-menu-item>
...
import { HomeOutlined, MessageOutlined, TeamOutlined, CalendarOutlined, FileTextOutlined, InfoCircleOutlined, UserOutlined } from '@ant-design/icons-vue';
